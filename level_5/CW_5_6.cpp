/*
You are given an array of integers. Your task is to find the largest possible sum of a contiguous subarray.
...
Дан массив целых чисел. Необходимо найти максимальную сумму непрерывного подмассива.
