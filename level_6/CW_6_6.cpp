/*
Write a function that accepts an array of 10 integers and returns a string representing these numbers in the format of a phone number.
...
Напишите функцию, которая принимает массив из 10 целых чисел и возвращает строку, представляющую эти числа в формате телефонного номера.
